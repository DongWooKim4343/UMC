...
public class QUser extends EntityPathBase<User> {
    ...
    private static final long serialVersionUID = -110731510L;
    ...
    public final EnumPath<umc.spring.domain.enums.Provider> provider = createEnum("provider", umc.spring.domain.enums.Provider.class);
